...
Your app code should be in the container's `/app` directory, it should have a `main.py` file (or somehow a `main` module) and that `main.py` file (or module) should have a Flask object `app`.
